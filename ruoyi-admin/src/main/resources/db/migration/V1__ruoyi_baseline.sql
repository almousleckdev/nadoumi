...
--
-- The current known-good RuoYi + Quartz schema, verbatim concatenation of:
--   sql/ry_20260417.sql   (20 business tables + seed data)
--   sql/quartz.sql        (11 QRTZ_* tables + seed rows)
--
-- On an EXISTING populated database this file is NOT executed: Flyway records a
-- BASELINE marker at version 1 (spring.flyway.baseline-on-migrate=true) and the
-- existing schema/data is left untouched. It runs only against a fresh/empty
-- database (local first-time setup, CI Testcontainers).
--
-- Do not edit after it has been applied anywhere — Flyway checksums are frozen.
-- Nadoumi schema changes start at V3 (see docs/DATABASE_DESIGN.md §6).
-- =============================================================================
