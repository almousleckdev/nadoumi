...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            {
                throw new Exception(StringUtils.format("Illegal file name ({}); download not allowed. ", fileName));
            }
            ...
            throws Exception
    {
        try
        {
            ...
            {
                throw new Exception(StringUtils.format("Illegal resource path ({}); download not allowed. ", resource));
            }
            // 本地资源路径
