...
/**
 * Union of two message lists, unique by id, oldest first. Folds a freshly fetched page
 * (live ping, resync, or a just-sent reply) into what is on screen without duplicating
 * or reordering anything already shown.
 */
