...
/** {@code text/event-stream} of ping-only realtime events for the signed-in student. */
@RestController
...
public class StudentStreamController {
    ...
    public StudentStreamController(SseConnectionRegistry registry, CurrentCaller caller) {
