...
| `V57+__…` | `nadoumi-application` `nad_wf_*` + `nad_application*` (Step 6); `nadoumi-document` (Step 7); communication, **payment (Step 9, greenfield)**, content, reporting. Next new migration is **V57**. | Step 6+ |

**`FlywayMigrationsIT` counts (after `V56`):** **53 fresh / 52 baselined**
