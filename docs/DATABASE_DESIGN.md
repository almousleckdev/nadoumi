...
| `V54+__…` | `nadoumi-application` `nad_wf_*` + `nad_application*` (Step 6); `nadoumi-document` (Step 7); communication, **payment (Step 9, greenfield)**, content, reporting. Next new migration is **V54**. | Step 6+ |

**`FlywayMigrationsIT` counts (after `V53`):** **50 fresh / 49 baselined**
